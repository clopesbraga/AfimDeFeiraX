...
@Database(entities = arrayOf((LoginModel::class),(ComprasModel::class),(ListaModel::class),(HistoricoModel::class)), version = 5)
...
abstract class DbAfimDeFeira : RoomDatabase() {
    ...
    companion object {
        ...
        private val MIGRATION_3_4: Migration = object : Migration(4, 5) {
